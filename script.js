...
const checkAnswer = () => {
    ...
    if (selectedAnswer) {
        ...
        if (selectedAnswerText === questions[currentQuestion - 1].correct_answer) {
            score++;
            ...
            const correctAnswer = document
                ...
                .forEach((answerElement) => {
                    if (answerElement.querySelector(".text").innerHTML === questions[currentQuestion - 1].correct_answer) {
